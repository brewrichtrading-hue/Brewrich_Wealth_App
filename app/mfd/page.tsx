    ...
    <div className="min-h-screen bg-blue-600 text-white selection:bg-white selection:text-blue-600">
      ...
      <nav className="border-b border-blue-500/30 bg-blue-600 sticky top-0 z-50 px-6 py-4 shadow-sm">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a href="https://partner.assetplus.in" target="_blank" rel="noreferrer" className="text-xs md:text-sm font-semibold px-4 py-2 rounded-xl bg-white text-blue-600 hover:bg-blue-50 transition-all shadow-md">
              Client Portal Login
            </a>
          </div>
        </div>
      ...
      <section className="relative px-6 pt-16 pb-20 md:pt-24 md:pb-28 max-w-7xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <a href="https://partner.assetplus.in" target="_blank" rel="noreferrer" className="px-8 py-4 rounded-2xl bg-white text-blue-600 font-bold hover:bg-blue-50 transition-all shadow-xl">
            Manage My Wealth →
          </a>
          <a href="#consultation" className="px-8 py-4 rounded-2xl bg-blue-700/80 border border-blue-400/40 text-white font-bold hover:bg-blue-700 transition-all shadow-lg">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-2xl bg-slate-900 border border-slate-800 hover:border-blue-500 transition-all shadow-lg">
              ...
              <p className="text-slate-400 text-sm mb-6">Discipline-driven monthly compounding across curated Flexi-Cap, Mid-Cap, and Index fund baskets.</p>
            ...
            <div className="p-8 rounded-2xl bg-slate-900 border border-slate-800 hover:border-blue-500 transition-all shadow-lg">
              ...
              <p className="text-slate-400 text-sm mb-6">Manage cash flows with Systematic Withdrawal Plans (SWP) or dynamically balance risk via Systematic Transfers (STP).</p>
              <div className="border-t border-slate-800 pt-4 text-xs text-slate-300 space-y-1">
            ...
            <div className="p-8 rounded-2xl bg-slate-900 border border-slate-800 hover:border-emerald-500 transition-all shadow-lg relative">
              ...
              <p className="text-slate-400 text-sm mb-6">Comprehensive life protection safeguarding your family capital and business continuity against contingencies.</p>
              <div className="border-t border-slate-800 pt-4 text-xs text-slate-300 space-y-1">
            ...
            <div className="p-8 rounded-2xl bg-slate-900 border border-slate-800 hover:border-emerald-500 transition-all shadow-lg relative">
              ...
              <p className="text-slate-400 text-sm mb-6">Robust health mediclaim coverage featuring instant digital health cards and 10,000+ cashless hospital networks.</p>
              <div className="border-t border-slate-800 pt-4 text-xs text-slate-300 space-y-1">
            ...
            <div className="p-8 rounded-2xl bg-slate-900 border border-slate-800 hover:border-amber-500 transition-all shadow-lg">
              ...
              <p className="text-slate-400 text-sm mb-6">Secure predictable compounding with AAA-rated Fixed Deposits and tax-saving National Pension System (NPS).</p>
              <div className="border-t border-slate-800 pt-4 text-xs text-slate-300 space-y-1">
            ...
            <div className="p-8 rounded-2xl bg-slate-900 border border-slate-800 hover:border-purple-500 transition-all shadow-lg relative">
              ...
              <p className="text-slate-400 text-sm mb-6">Get instant liquidity without breaking your long-term mutual fund compounding. Pledge units digitally for fast overdraft credit.</p>
              <div className="border-t border-slate-800 pt-4 text-xs text-slate-300 space-y-1">
      ...
      <section id="consultation" className="bg-blue-900 text-white px-6 py-20 text-center border-t border-blue-800">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-blue-200 mb-8">Discuss your portfolio strategy, insurance coverage, or tax-saving asset allocation directly with our professional desk.</p>
          <a href="https://wa.me/919042747590" target="_blank" rel="noreferrer" className="inline-block px-8 py-4 rounded-xl bg-white text-blue-900 font-bold hover:bg-blue-50 transition-all shadow-xl">
